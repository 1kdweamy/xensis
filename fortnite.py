...
try:
    ...
    print(e)
    print(Fore.RED + f'[-] ' + Fore.RESET + 'Failed to import 1 or more modules. Run "INSTALL REQUIREMENTS.bat')
    exit()
...
print(f'\n A free lobbybot network, created by dweamy. Fixed for Patch {patch}.\n')
